...
# mv /zola/target/release/zola /usr/bin
# ZOLA_VERSION="0.17.2-1"
# ZOLA_DEBIAN_VERSION="amd64_bullseye"
# ZOLA_PKG="zola_${ZOLA_VERSION}_${ZOLA_DEBIAN_VERSION}.deb"
ZOLA_PKG="zola_0.17.2-1_amd64_bullseye.deb"
# curl -o "${ZOLA_PKG}" "https://github.com/barnumbirr/zola-debian/releases/download/v${ZOLA_VERSION}/${ZOLA_PKG}"
wget "https://github.com/barnumbirr/zola-debian/releases/download/v0.17.2-1/zola_0.17.2-1_amd64_bullseye.deb"
sudo dpkg -i ${ZOLA_PKG}
zola --version